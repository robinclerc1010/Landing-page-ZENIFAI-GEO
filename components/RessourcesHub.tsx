...
// Sources des tracés : Bootstrap Icons (MIT) pour OpenAI, simple-icons pour
// Google, Gemini et Perplexity ; logo Microsoft reconstruit (4 carrés).
        ...
        <section key={theme.id} id={theme.id} className="scroll-mt-28">
          ...
          <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4" role="list">
            {theme.articles.map((article, i) => {
              ...
              const brandLogo = BRAND_LOGOS[article.icon];
              const reveal = reduce
                ? {}
                : {
              ...
              return (
                <motion.li key={article.href} {...reveal}>
                  ...
                  >
                    ...
                    >
                      {brandLogo ?? <Icon size={22} strokeWidth={1.75} />}
                    </div>
